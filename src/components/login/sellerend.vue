<template>
	<div class="container">
		<vtitle :title="title">卖家注册</vtitle>
		<div class="from">
			<group title="卖家">
				<x-input is-type="china-name" placeholder="姓名" @on-change="change"></x-input>
				<popup-picker title="性别" :data="sexList" v-model="sex" value-text-align="right"></popup-picker>
				<x-input is-type="china-mobile" :max="8" placeholder="固定电话"></x-input>
				<x-input is-type="email" placeholder="邮箱"></x-input>
...
//	import { Group, XInput, PopupPicker, XButton } from 'vux'
	...
	import vagreement from '../components/agreement'
	...
	export default {
		data() {
			return {
				...
				postList: [['首席执行官CEO/总裁/总经理', '首席运营官COO/副总理/副总', '董事会秘书/仲裁助理/总经理助理', '总监', '企业发展规划经理/主管', '分公司/办事处/分支机构经理',
